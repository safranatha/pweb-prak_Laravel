    ...
    <div class="container-fluid d-flex flex-column justify-content-center align-items-center mb-4 vh-100">
        ...
        <form action="{{ route('StaffRegisterPost') }}" method="POST" class="w-25 mt-2 needs-validation" novalidate>
            ...
            <div class="mb-4 d-flex flex-row">
                <img id="Full_Name" src="Image/Vector/User.svg" class="mb-3" alt="User Icon"
                    style="width: 15px; margin-right: 10px;">
                <div class="d-flex flex-column w-100">
                    <input type="text" class="form rounded" name="username" id="Fullname_Register"
            ...
            <div class="mb-4 d-flex">
                <img id="Email_2" src="Image/Vector/Email.svg" class="mb-3" alt="User Icon"
                    style="width: 15px; margin-right: 10px;">
                <div class="d-flex flex-column w-100">
                    <input type="email" class="form rounded" name="email" id="Email_Register"
            ...
            <div class="mb-4 d-flex">
                <img id="Phone" src="Image/Vector/Mobile.svg" class="mb-3" alt="User Icon"
                    style="width: 15px; margin-right: 10px;">
                <div class="d-flex flex-column w-100">
                    <input type="text" class="form rounded" name="NoTelp" id="PhoneNumber_Register"
            ...
            <div class="mb-4 d-flex">
                <img id="Password" src="Image/Vector/Lock.svg" class="mb-3" alt="User Icon"
                    style="width: 15px; margin-right: 10px;">
                <div class="d-flex flex-column w-100">
                    <input type="password" class="form rounded" name="password" id="password_Register"
