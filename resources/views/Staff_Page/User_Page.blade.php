        ...
        <div class="container-fluid d-flex flex-column justify-content-center align-items-center">
          ...
          <form action="Admin_Dashboard.html" method="POST" class="w-50 mt-2 mb-5 needs-validation " novalidate>
            <div class="mb-4 d-flex flex-row">
              <img id="user-icon" src="../Env/Vector/User.svg" class="icon" alt="User Icon"
            ...
            <div class="mb-4 d-flex">
              <img id="password-icon" src="../Env/Vector/Lock.svg" class="icon" alt="User Icon"
                style="width: 15px; margin-right: 10px;">
              <div class="d-flex flex-column w-100">
                ...
                <p id="Password_Valid" class=" pt-2 ps-1" style="color: red;"">
                      ...
                      <div class=" mb-4 d-flex">
                  <img id="password-icon" src="../Env/Vector/Key.svg" class="icon" alt="User Icon"
                    style="width: 15px; margin-right: 10px;">
                <div class="d-flex flex-column w-100">
